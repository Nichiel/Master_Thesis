...
load_img_dir = '/content/saved_models/vgg19/003/img'
prototype_info = np.load('/content/saved_models/vgg19/003/img/epoch-10/bb10.npy')#np.load(os.path.join(load_img_dir, 'epoch-'+str(start_epoch_number), 'bb'+str(start_epoch_number)+'.npy'))
def save_prototype_original_img_with_bbox(fname, epoch, index,
                                          bbox_height_start, bbox_height_end,
                                          bbox_width_start, bbox_width_end, color=(0, 255, 255)):
    p_img_bgr = cv2.imread('/content/saved_models/vgg19/003/img/epoch-10/prototype-img-original0'+'.png')
